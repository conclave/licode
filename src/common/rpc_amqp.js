...
(function () {
    ...
    // Logger
    var log = require('./logger')('RPC-AMQP');
    ...
    function Endpoint (spec) {
        ...
        self.connect = function (callback) {
            ...
            connection = amqp.createConnection(spec.url || {
                host: spec.host,
                port: spec.port
            });
        ...
        self.bind = function (id, rpcPublic, callback) {
        ...
        //Subscribe to 'topic'
        self.bind_broadcast = function (id, callback) {
            //Create the queue for receive messages
         ...
         */
        self.broadcast = function (topic, message) {
